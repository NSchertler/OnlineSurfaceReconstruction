...
{
	template <>
	struct hash<HierarchyMortonMultiPass::Index>
	{
		size_t operator()(const HierarchyMortonMultiPass::Index& o) const
		{
			return o.idx;
		}
	};
...
namespace HierarchyMortonMultiPass
{
	...
	private:
		...
		void children(const MortonCode64 idx, int parentNodeLevel, MortonCode64& childLowerInclusive, MortonCode64& childUpperExclusive, int levelsDown = 1) const;
