...
extern void extract_graph(THierarchy& hierarchy, Float scale, bool extrinsic, IOrientationFieldTraits* rosy, IPositionFieldTraits* posy,
...
extern void extract_faces(std::vector<std::vector<TaggedLink> > &adj,
                          MatrixXf &posField, MatrixXf &N, MatrixXf &Nf, MatrixXu &F,
